...
public class RDFVault {
    ...
    public static void main(String[] args) {
        String s="<http://www.Department0.University0.edu/FullProfessor0>";
        String s1="<http://www.Department0.University0.edu/FullProfessor1>";
        RDFVault rdfVault=new RDFVault();
        String codes=rdfVault.encode(s).toString();
        System.out.println(codes) ;
        System.out.println(rdfVault.decode(codes));
        //Leaf@27c170f0
        //Leaf@27c170f0
    }
}
